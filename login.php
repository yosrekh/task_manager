...
<div class="split-bg">
    ...
    <div class="right-panel">
        <div class="form-container login-container" role="main" aria-label="Login form">
            <form method="POST" action="login.php" class="form animated-form" novalidate autocomplete="off">
                <h2>Login</h2>
                <?php if (!empty($errors)): ?>
                ...
                <div class="input-group">
                    <input type="email" id="email" name="email" placeholder="Email address" value="<?=htmlspecialchars($_POST['email'] ?? '')?>" required autocomplete="email" autofocus />
                </div>
